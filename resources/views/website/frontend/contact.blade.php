            ...
            <div class="container py-5">
                <div class="p-5 bg-light rounded">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <form action="{{ route('contactstore') }}" method="POST" class="">
                            @csrf
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">{{$contactadmin->address}}</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2">{{$contactadmin->email}}</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded bg-white">
                                ...
                                <div>
                                    <h4>Telephone</h4>
                                    <p class="mb-2">{{$contactadmin->telephone}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
