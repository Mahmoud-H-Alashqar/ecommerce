...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <a href="{{ route('control_panel_dashboard') }}" class="nav-link active">
        ...
        <p>
            Dashboard
			 ...
			 <li class="nav-item menu-open">
    <a href="#" class="nav-link" id="settingsMenu">
    ...
    <ul class="nav nav-treeview" id="settingsSubMenu">
        <li class="nav-item">
            <a href="{{ route('control_panel_dashboard.permissions.index') }}" class="nav-link">
                <i class="nav-icon bi bi-circle"></i>
                <p>Permissions</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('control_panel_dashboard.roles.index') }}" class="nav-link">
                <i class="nav-icon bi bi-circle"></i>
                <p>Roles</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('control_panel_dashboard.users.index') }}" class="nav-link">
                <i class="nav-icon bi bi-circle"></i>
                <p>Users</p>
            </a>
        </li>
