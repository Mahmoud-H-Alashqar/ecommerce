...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0">Create New User</h3></div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <!-- نموذج إنشاء مستخدم -->
                            <form method="POST" action="{{ route('control_panel_dashboard.users.store') }}">
                                @csrf
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <select name="role" id="role" class="form-control">
                                        <option value="" disabled selected>Choose a role</option> <!-- خيار افتراضي -->
