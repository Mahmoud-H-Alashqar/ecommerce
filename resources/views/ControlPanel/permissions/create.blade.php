...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0">Create New Permission</h3></div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <!-- نموذج إنشاء صلاحية -->
                            <form method="POST" action="{{ route('control_panel_dashboard.permissions.store') }}">
                                @csrf

                                <!-- Field for Permission Name -->
                                <div class="form-group">
                                    <label for="permission_name">Permission Name</label>
                                    <input type="text" id="permission_name" name="name" class="form-control" placeholder="Enter Permission Name" value="{{ old('name') }}" required>
