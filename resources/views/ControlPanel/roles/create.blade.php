...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0">Create New Role</h3></div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <!-- نموذج إنشاء دور -->
                            <form method="POST" action="{{ route('control_panel_dashboard.roles.store') }}">
                                @csrf

                                <!-- Field for Role Name -->
                                <div class="form-group">
                                    <label for="role_name">Role Name</label>
                                    <input type="text" id="role_name" name="name" class="form-control" placeholder="Enter Role Name" value="{{ old('name') }}" required>
                                ...
                                <!-- Field for Permissions (Optional) -->
