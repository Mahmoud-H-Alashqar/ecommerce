...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0">Create New Category</h3></div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <!-- نموذج إنشاء تصنيف -->
                            <form method="POST" action="{{ route('control_panel_dashboard.categories.store') }}">
                                @csrf

                                <!-- حقل اسم التصنيف -->
                                <div class="form-group">
                                    <label for="category_name">Category Name</label>
                                    <input type="text" id="category_name" name="name" class="form-control" placeholder="Enter Category Name" value="{{ old('name') }}" required>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <textarea id="category_description" name="description" class="form-control" placeholder="Enter Category Description" rows="4">{{ old('description') }}</textarea>
